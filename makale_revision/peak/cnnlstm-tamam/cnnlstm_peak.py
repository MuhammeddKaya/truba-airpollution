...
def train_and_evaluate(params):
    ...
    with open("cnnlstm_zscore_peak_results.txt", "a") as f:
        f.write(str({
            'neurons': neurons,
            'dropout': dropout,
            'optimizer': optimizer,
...
param_combinations = list(product(
    neurons_list, dropout_list, optimizer_list, time_window_sizes, batch_size_list, conv_neurons_list, cnn_layers_list, lstm_layers_list
))
...
print("Z-score tabanlı peak analizi tamamlandı. Sonuçlar 'cnnlstm_zscore_peak_results.txt' dosyasına kaydedildi.")
