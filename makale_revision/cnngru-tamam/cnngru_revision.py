...
def train_and_evaluate(params):
    ...
    with open("cnn_gru_revision.txt", "a") as f:
        f.write(str({
            'neurons': neurons,
            'dropout': dropout,
            'optimizer': optimizer,
...
gru_layers_list = [2, 3] # 2

param_combinations = list(product(neurons_list, dropout_list, optimizer_list, time_window_sizes, batch_size_list, conv_neurons_list, cnn_layers_list, gru_layers_list))
...
print("Results saved to 'cnn_gru_revision.txt'")