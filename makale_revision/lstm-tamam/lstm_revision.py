...
def build_lstm(neurons=50, dropout=0.2, optimizer='adam', h_layers=4):
    model = Sequential()
...
def train_and_evaluate(params):
    ...
    model = build_lstm(neurons=neurons, dropout=dropout, optimizer=optimizer, h_layers=h_layers)
    ...
    with open("./lstm_revision_results.txt", "a") as f:
        f.write(str({
            'neurons': neurons,
            'dropout': dropout,
            'h_layers': h_layers,
...
print("Results saved to 'lstm_revision_results.txt'")